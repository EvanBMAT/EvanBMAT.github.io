        ...
        */
                ...
                var n = e.displayName || e.name || "Component",
                    ...
                    a = function(n) {
                        ...
                        return function(t, e) {
                            ...
                            var e = y({}, t);
                            return x && (e.ref = this.setWrappedInstance), d && (e[d] = this.renderCount++), this.propsMode && this.subscription && (e[k] = this.subscription), e
        ...
        t.exports = function() {
            ...
            Yt[Ft] = !0, Yt.delete = Yt.remove, Yt.removeIn = Yt.deleteIn, qt.prototype.get = function(t, e, n, r) {
                ...
                if (C(a), (s || !f) && C(i), !s || 1 !== u.length) {
                    if (!f && !s && u.length >= ce) return function(t, e, n, r) {
                        t || (t = new E);
                        for (var o = new Gt(t, xt(n), [n, r]), i = 0; i < e.length; i++) {
                            var a = e[i];
                ...
                var s = o === v,
                    u = dt(r, this.entry[0]);
                return (u ? o === this.entry[1] : s) ? this : (C(a), s ? void C(i) : u ? t && t === this.ownerID ? (this.entry[1] = o, this) : new Gt(t, this.keyHash, [r, o]) : (C(i), ne(this, t, e, xt(r), [r, o])))
            ...
            function Se(t, e, n) {
                ...
                var h = t._tail,
                    d = p < f ? xe(t, s - 1) : p > f ? new ge([], r) : h;
                if (h && p > f && a < i && h.array.length) {
                    for (var g = c = Me(c, r), v = u; v > m; v -= m) {
                        var b = f >>> v & y;
                        g = g.array[b] = Me(g.array[b], r)
                    }
                    g.array[f >>> m & y] = h
                }
            ...
            return Nn[p] = !0, Nn[L] = An.entries, Nn.__toJS = An.toObject, Nn.__toStringMapper = function(t, e) {
                ...
                zip: function() {
                    return Ke(this, Qe(this, Ln, [this].concat(M(arguments))))
                },
                zipWith: function(t) {
                    var e = M(arguments);
        ...
        t.exports = function(t, e) {
            ...
            return function(t, e) {
                ...
                U = at(), N = G ? function(t, e) {
                    var n = at();
                    n.column += e, n.offset += e, G.call(X, x[t], n, t)
                } : f, tt--, $++;
                for (; ++tt < $;)
                    if ("\n" === T && (nt = J[et] || 1), "&" !== (T = st(tt))) "\n" === T && (rt++, et++, nt = 0), T ? (ot += T, nt++) : ut();
                        ...
                        (a = ";" === st(Y)) && (Y++, (i = L === h && u(p)) && (n = p, P = i)), F = 1 + Y - R, (a || H) && (p ? L === h ? (a && !P ? N(C, 1) : (n !== p && (Y = j + n.length, F = 1 + Y - j, a = !1), a || (O = n ? v : _, e.attribute ? "=" === (A = st(Y)) ? (N(O, F), P = null) : s(A) ? P = null : N(O, F) : N(O, F))), I = P) : (a || N(b, F), S(I = parseInt(p, g[L])) ? (N(M, F), I = "�") : I in o ? (N(E, F), I = o[I]) : (D = "", k(I) && N(E, F), I > 65535 && (D += l((I -= 65536) >>> 10 | 55296), I = 56320 | 1023 & I), I = D + l(I))) : L !== h && N(w, F)), I ? (ut(), U = at(), tt = Y - 1, nt += Y - R + 1, it.push(I), (B = at()).offset++, W && W.call(K, I, {
                            start: U,
                            end: B
        ...
        x[v] = "Named character references must be terminated by a semicolon", x[b] = "Numeric character references must be terminated by a semicolon", x[_] = "Named character references cannot be empty", x[w] = "Numeric character references cannot be empty", x[C] = "Named character references must be known", x[E] = "Numeric character references cannot be disallowed", x[M] = "Numeric character references cannot be outside the permissible Unicode range"
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        (t.exports = n(10)(!1)).push([t.i, ".launcher .badge{position:fixed;top:-10px;right:-5px;background-color:red;color:#fff;width:25px;height:25px;text-align:center;line-height:25px;border-radius:50%}", ""])
    }, function(t, e, n) {
        var r = n(175);
        "string" == typeof r && (r = [
            [t.i, r, ""]
        ...
        (e = t.exports = n(10)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".messages-container{background-color:#fff;height:50vh;max-height:425px;overflow-y:auto;padding-top:10px}.widget-embedded .messages-container{height:100vh;max-height:100%}.full-screen .messages-container{height:100%;max-height:none}@media screen and (max-width:800px){.messages-container{height:100%;max-height:none}}", ""])
    }, function(t, e, n) {
        var r = n(186);
        "string" == typeof r && (r = [
            [t.i, r, ""]
        ...
        (e = t.exports = n(10)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".conversation-container .message{margin:10px;display:flex;font-size:14px;font-family:Roboto,serif}.conversation-container .message .markdown p{margin:0}.conversation-container .client{background-color:#018ac0;color:#fff;border-radius:10px;padding:15px;max-width:215px;text-align:left;font-family:Roboto,serif;margin-left:auto;overflow-wrap:break-word}.conversation-container .client a{color:#35cce6}.conversation-container .response{background-color:#f4f7f9;color:#000;border-radius:10px;padding:15px;max-width:215px;text-align:left;font-family:Roboto,serif;overflow-wrap:break-word}.conversation-container .message-text{margin:0}.conversation-container .avatar{width:40px;height:40px;border-radius:100%;margin-right:10px}", ""])
    }, function(t, e, n) {
        var r = n(194);
        "string" == typeof r && (r = [
            [t.i, r, ""]
        ...
        function g(t, e, n) {
            var o, g, y, v, b, _, w, C, E = e.charAt(0),
                ...
                T = a,
                I = c;
            if ("!" === E && (T = s, k = E, E = e.charAt(++M)), E === d) {
                if (M++, k += E, _ = "", this.options.footnotes && e.charAt(M) === p) {
                    if (T === s) return;
                    k += p, M++, T = u
                }
                for (C = 0; M < x;) {
                    if ((E = e.charAt(M)) === d) w = !0, C++;
                    else if (E === m) {
                        if (!C) break;
                        C--
                    }
                    E === h && (_ += h, E = e.charAt(++M)), _ += E, M++
                }
                if (S = _, o = _, (E = e.charAt(M)) === m) {
                    for (M++, S += E, _ = ""; M < x && (E = e.charAt(M), r(E));) _ += E, M++;
                    if (E = e.charAt(M), T !== u && E === d) {
                        for (g = "", _ += E, M++; M < x && (E = e.charAt(M)) !== d && E !== m;) E === h && (g += h, E = e.charAt(++M)), g += E, M++;
                        (E = e.charAt(M)) === m ? (I = g ? f : l, _ += g + E, M++) : g = "", S += _, _ = ""
                    } else {
                        if (!o) return;
                        g = o
                    }
        ...
        function g(t, e, n) {
            var o, g, y, v, b, _, w, C, E, M, x, S, k, T, I, A, N, O, D, P = "",
                j = 0,
                R = e.charAt(0),
            ...
            if ("!" === R && (E = !0, P = R, R = e.charAt(++j)), R === s && (E || !this.inLink)) {
                ...
                if (o) {
                    for (M = I, P += I + _, j++; j < S && (R = e.charAt(j), r(R));) P += R, j++;
                    ...
                    if (R = e.charAt(j), P += I, I && i.call(C, R))
                        if (j++, P += R, I = "", x = C[R], b = P, z) {
                            for (; j < S && (R = e.charAt(j)) !== x;) R === a && (I += a, R = e.charAt(++j)), j++, I += R;
                            if ((R = e.charAt(j)) !== x) return;
                            for (k = I, P += I + R, j++; j < S && (R = e.charAt(j), r(R));) P += R, j++
                        } else
                            for (_ = ""; j < S;) {
                                if ((R = e.charAt(j)) === x) w && (I += x + _, _ = ""), w = !0;
                                else if (w) {
                                    if (R === l) {
                                        P += I + x + _, k = I;
                                        break
                                    }
                                    r(R) ? _ += R : (I += x + _ + R, _ = "", w = !1)
                                } else I += R;
                                j++
                            }
                    if (e.charAt(j) === l) return !!n || (P += l, A = this.decode.raw(this.unescape(A), t(v).test().end, {
                        ...
                        title: k || null,
                        url: A
                    }, E ? D.alt = this.decode.raw(this.unescape(M), N) || null : (O = this.enterLink(), D.children = this.tokenizeInline(M, N), O()), t(P)(D))
                }
            }
        }
        m['"'] = '"', m["'"] = "'", m[c] = l
        ...
        function m(t, e, n) {
            ...
            if (this.options.gfm) {
                for (i = "", y = -1, w = d; ++y < w;)
                    ...
                    for (y = i.length, w = e.length, C = "", E = 0; y < w && (g = e.charAt(y), !o(g) && g !== l) && ("." !== g && "," !== g && ":" !== g && ";" !== g && '"' !== g && "'" !== g && ")" !== g && "]" !== g || (M = e.charAt(y + 1)) && !o(M)) && (g !== u && g !== a || E++, g !== c && g !== s || !(--E < 0));) C += g, y++;
                    if (C) {
                        if (m = i += C, b === p) {
                            if (-1 === (v = C.indexOf(f)) || v === w - 1) return;
                            m = m.substr(p.length)
                        }
                        return !!n || (x = this.enterLink(), m = this.tokenizeInline(m, t.now()), x(), t(i)({
                            type: "link",
                            title: null,
                            url: r(i, {
                                nonTerminated: !1
        ...
        var r = n(11);
        t.exports = function(t, e, n) {
            var v, b, _, w, C, E, M, x, S, k, T, I, A, N, O, D, P, j, R, L, z, U, B, F;
            if (!this.options.gfm) return;
            v = 0, j = 0, E = e.length + 1, M = [];
            for (; v < E;) {
                if (U = e.indexOf(l, v), B = e.indexOf(s, v + 1), -1 === U && (U = e.length), -1 === B || B > U) {
                    if (j < h) return;
                    break
                }
                M.push(e.slice(v, U)), j++, v = U + 1
            }
            w = M.join(l), b = M.splice(1, 1)[0] || [], v = 0, E = b.length, j--, _ = !1, T = [];
            for (; v < E;) {
                if ((S = b.charAt(v)) === s) {
                    if (k = null, !1 === _) {
                        if (!1 === F) return
            ...
            for (; ++P < j;) {
                for (R = M[P], C = {
                        type: "tableRow",
                        children: []
                    }, P && t(l), t(R).reset(C, z), E = R.length + 1, v = 0, x = "", I = "", A = !0, N = null, O = null; v < E;)
                        ...
                        if ("" === S || S === s)
                            if (A) t(S);
                                ...
                                if (S && O) {
                                    x += S, v++;
                                    continue
                                }!I && !S || A || (w = I, x.length > 1 && (S ? (w += x.slice(0, x.length - 1), x = x.charAt(x.length - 1)) : (w += x, x = "")), D = t.now(), t(w)({
                                    type: "tableCell",
                                    children: this.tokenizeInline(I, D)
                                }, C)), t(x + S), x = "", I = ""
                            }
                        else if (x && (I += x, x = ""), I += S, S === o && v !== E - 2 && (I += R.charAt(v + 1), v++), S === i) {
        ...
        function v(t, e, n) {
            for (var r, y, v, w, C, E, M, x, S = this.options.commonmark, k = 0, T = e.length, I = ""; k < T && ((w = e.charAt(k)) === l || w === c);) I += w, k++;
            if ((w = e.charAt(k)) === f) {
                ...
                if (v && e.charAt(k) === p && e.charAt(k + 1) === m) {
                    ...
                    if (v) {
                        for (M = v, v = ""; k < T && ((w = e.charAt(k)) === c || w === l || w === u);) v += w, k++;
                        ...
                        return (w = e.charAt(k)) && w !== u ? void 0 : !!n || (r = t(r).test().end, M = this.decode.raw(this.unescape(M), r, {
                            nonTerminated: !1
                        }), x && (y = t(y).test().end, x = this.decode.raw(this.unescape(x), y)), t(I)({
                            type: "definition",
                            identifier: o(E),
                            title: x || null,
                            url: M
        ...
        function d(t, e, n) {
            var d, m, g, y, v, b, _, w, C, E, M, x, S = this.offset;
            if (this.options.footnotes) {
                ...
                if (e.charAt(d) === c && e.charAt(d + 1) === f) {
                    ...
                    if (_ && e.charAt(d) === l && e.charAt(d + 1) === p) {
                        ...
                        }), M = t(g), x = this.enterBlock(), b = this.tokenizeBlock(b, y), x(), M({
        ...
        t.exports = function(t, e, n) {
            ...
            if (Q >= g) return;
            if (m = e.charAt(V), o = F ? M : E, !0 === C[m]) y = m, s = !1;
            else {
            ...
            for (; ++V < W;) D = A[V].value.join(h), z = t.now(), (D = t(D)(x(this, D, z), L)).loose && (R = !0), D = A[V].trail.join(h), V !== W - 1 && (D += h), t(D);
        ...
        t.exports = function(t, e, n) {
            ...
            for (; k < E;) {
                ...
                d = m === k ? h : e.slice(m, p), S.push(k - m), M.push(d), x.push(h), k = p + 1
            }
            k = -1, E = S.length, c = t(M.join(i));
            for (; ++k < E;) v[C] = (v[C] || 0) + S[k], C++;
            return y = this.enterBlock(), x = this.tokenizeBlock(x.join(i), w), y(), c({
                type: "blockquote",
                children: x
            })
        };
        ...
        t.exports = function(t, e, n) {
            var f, p, h, d, m, g, y, v, b, _, w, C = this.options,
                ...
                x = "";
            if (!C.gfm) return;
            for (; M < E && ((h = e.charAt(M)) === a || h === i);) x += h, M++;
            if (_ = M, (h = e.charAt(M)) !== s && h !== u) return;
            M++, p = h, f = 1, x += h;
            for (; M < E && (h = e.charAt(M)) === p;) x += h, f++, M++;
            if (f < c) return;
            for (; M < E && ((h = e.charAt(M)) === a || h === i);) x += h, M++;
            d = "", m = "";
            for (; M < E && (h = e.charAt(M)) !== o && h !== s && h !== u;) h === a || h === i ? m += h : (d += m + h, m = ""), M++;
            if ((h = e.charAt(M)) && h !== o) return;
            if (n) return !0;
            (w = t.now()).column += x.length, w.offset += x.length, x += d, d = this.decode.raw(this.unescape(d), w), m && (x += m);
            m = "", v = "", b = "", g = "", y = "";
            for (; M < E;)
                if (h = e.charAt(M), g += v, y += b, v = "", b = "", h === o) {
                    for (g ? (v += h, b += h) : x += h, m = "", M++; M < E && (h = e.charAt(M)) === a;) m += h, M++;
                    if (v += m, b += m.slice(_), !(m.length >= l)) {
                        for (m = ""; M < E && (h = e.charAt(M)) === p;) m += h, M++;
                        if (v += m, b += m, !(m.length < f)) {
                            for (m = ""; M < E && ((h = e.charAt(M)) === a || h === i);) v += h, b += h, M++;
                            if (!h || h === o) break
                        }
                    }
                } else g += h, b += h, M++;
        ...
        t.exports = function t() {
            ...
            w.processSync = function(t) {
                var e, n = !1;
                return C(), h("processSync", w.Parser), d("processSync", w.Compiler), M(e = i(t), function(t) {
                    n = !0, o(t)
        ...
        (e = t.exports = n(10)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".conversation-container .image-details{object-fit:scale-down;max-width:100%;margin-top:10px}.conversation-container .image-frame{object-position:0 0;object-fit:cover;width:100%;height:100%}", ""])
    }, function(t, e, n) {
        var r = n(280);
        "string" == typeof r && (r = [
            [t.i, r, ""]
        ...
        (e = t.exports = n(10)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".conversation-container .videoFrame{width:300px;height:200px;margin-top:10px;border:none}", ""])
    }, function(t, e, n) {
        var r = n(283);
        "string" == typeof r && (r = [
            [t.i, r, ""]
        ...
        (e = t.exports = n(10)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".conversation-container .header{background-color:#018ac0;color:#fff;display:flex;flex-direction:column;justify-content:center;text-align:center;height:55px;font-family:Roboto,serif}.conversation-container .title{font-size:20px;margin:0;font-family:Roboto,serif}.conversation-container .close-button{display:none}.conversation-container .loading{background-color:#b5b5b5;color:#fff;display:flex;flex-direction:column;text-align:center;padding:5px 0;font-family:Roboto,serif;font-size:14px}.widget-embedded .header{display:none}.full-screen .header{border-radius:0;flex-shrink:0;position:relative}.full-screen .close-button{display:flex;justify-content:center;align-items:center;background-color:#018ac0;border:0;position:absolute;right:10px;width:40px}.full-screen .close{width:30px;height:30px}.full-screen .close.default{width:20px;height:20px}.full-screen .loading{border-radius:0;flex-shrink:0;position:relative}@media screen and (max-width:800px){.conversation-container .header{border-radius:0;flex-shrink:0;position:relative}.conversation-container .close-button{display:flex;justify-content:center;align-items:center;background-color:#018ac0;border:0;position:absolute;right:10px;width:40px}.conversation-container .close{width:30px;height:30px}.conversation-container .close.default{width:20px;height:20px}.conversation-container .loading{border-radius:0;flex-shrink:0;position:relative}}", ""])
    }, function(t, e, n) {
        var r = n(288);
        "string" == typeof r && (r = [
            [t.i, r, ""]
            ...
            return function(t, e) {
                ...
                value: function() {
                    ...
                    n.on("connect", function() {
                        ...
                        console.log(e), "io client disconnect" !== e && t.props.dispatch((0, u.disconnectServer)())
        ...
        Z.displayName = "ReactDOMComponent", Z.Mixin = {
            mountComponent: function(t, e, n, r) {
                ...
                if (D(this, f), null != e ? (o = e._namespaceURI, a = e._tag) : n._tag && (o = n._namespaceURI, a = n._tag), (null == o || o === u.svg && "foreignobject" === a) && (o = u.html), o === u.html && ("svg" === this._tag ? o = u.svg : "math" === this._tag && (o = u.mathml)), this._namespaceURI = o, t.useCreateElement) {
                    ...
                    m.precacheNode(this, p), this._flags |= M.hasCachedChildNodes, this._hostParent || l.setAttributeForRoot(p), this._updateDOMProperties(null, f, t);
                    var w = s(p);
            ...
            _updateDOMProperties: function(t, e, n) {
                ...
                for (r in t)
                    if (!e.hasOwnProperty(r) && t.hasOwnProperty(r) && null != t[r])
                        ...
                        } else T.hasOwnProperty(r) ? t[r] && x(this, r) : K(this._tag, t) ? N.hasOwnProperty(r) || l.deleteValueForAttribute(S(this), r) : (c.properties[r] || c.isCustomAttribute(r)) && l.deleteValueForProperty(S(this), r);
                for (r in e) {
                    var f = e[r],
                    ...
                    else if (T.hasOwnProperty(r)) f ? P(this, r, f, n) : p && x(this, r);
        ...
        i.canUseDOM && (M = f("input") && (!document.documentMode || document.documentMode > 9));
        var N = {
            eventTypes: h,
            ...
            extractEvents: function(t, e, n, r) {
                ...
                if (! function(t) {
                    ...
                    }(s) ? p(s) ? M ? o = A : (o = T, i = k) : function(t) {
                        var e = t.nodeName;
